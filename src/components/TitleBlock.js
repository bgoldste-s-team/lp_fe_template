const TitleBlock = ({page}) => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-2xl">
      <h1 className="py-6  text-2xl sm:text-4xl md:text-5xl font-bold break-words ">{page.title}</h1>
      <p className="py-2">{page.page_description}</p>
      <p className="text-sm py-2">Last Updated: {new Date(page.publish_date).toLocaleDateString()}</p>
