            ...
            <div className="hero-content flex-col lg:flex-row  items-start">
                ...
                <div>
                    <h1 className="text-4xl ">Don't Just Browse The Web. <br />
                        <span className={'font-bold'}>Create it.</span>
                    </h1>
                    <p className="py-2">Pagesake lets you build beautiful websites, complete with content, monetization options, and beautiful design, all in seconds - for free. </p>
