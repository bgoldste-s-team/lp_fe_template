...
const Navbar = ({site}) => {
  ...
  return (
      ...
      <div className="navbar bg-base-100 sticky text-base-content p-2  top-0 z-50">
          ...
          <div className="navbar-start ">
              ...
              <Link href="/"className="btn-md  hidden sm:block btn-ghost self-center text-lg lg:text-2xl  break-words px-0 mx-0 ">     {siteName}</Link>
          </div>
          <div className="navbar-center sm:hidden ">
              {/*<img src={siteData.site_image} className="w-16 rounded-full mr-2" />*/}
              <Link href="/"className="btn-md   btn-ghost self-center text-2xl text-base-content break-words px-0 mx-0 ">
