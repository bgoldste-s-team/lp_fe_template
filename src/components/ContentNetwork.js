...
export default function ContentNetwork({}) {
  ...
  return (
    <div className="bg-base-300 p-4">
      <h2 className="text-base-content text-center py-2 text-3xl">
        Related Content
      </h2>
            ...
            <div className="card card-compact p-4 w-120 h-120 bg-base-100 shadow-xl overflow-hidden">
              <figure className="relative w-40 h-40">
                <Image
                  ...
                  layout="fill"
                  objectFit="cover" // or any other object-fit property
                  className="rounded-md" // You can still use TailwindCSS classes
                />
              </figure>
